...
const Footer = () => {
  return (
    <>
        <footer className="footer sm:footer-horizontal bg-dotted-spacing-1 text-xl text-white font-outfit flex flex-col md:flex-row items-center md:justify-around text-neutral-content p-10">
            <nav>
        ...
        <footer className="footer md:px-72 bg-dotted-spacing-1 text-base-content border-base-300 border-t px-10 py-4">
            <aside className="grid-flow-col items-center">
                ...
                Hire Me.
                <br />
                Hire Smarter, Not Harder with AI-Driven Recruitment
                </p>
            </aside>
